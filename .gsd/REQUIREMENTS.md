...
- Validation: unmapped
- Notes: Server-enforced confirmation boundary in server/external-actions.js (D051). S02/T01 proves the gate rejects execution without prior confirmation. UI confirmation in ExternalActionsPanel is supplementary.
...
- Supporting slices: none
- Validation: unmapped
- Notes: Un-deferred for M005 — domain purchase execution ships behind the confirmation-gated action model (R018). Porkbun is the first provider (D051).
...
- Validation: validated
- Notes: Domain availability and trademark signal artifacts render with status badges and mandatory advisory disclaimers (D026). DomainSignalsRenderer and TrademarkSignalsRenderer proven by renderer tests. Signals clearly labeled as point-in-time advisory, not legal clearance. M005/S01 extends to real Porkbun API data with source attribution, enriched fields (renewal price, promo badge), and D026-compliant trademark advisory framing. Live vs simulated data distinguishable by artifact metadata.engine.
...
- Validation: validated
- Notes: M003/S02 proves GSD bootstrap (repo creation, artifact packaging, project structure). M004/S01+S02 prove autonomous execution (agent spawn, live supervision, retry/escalation, multi-project isolation). Full chain from approval to autonomous build proven.
...
- Validation: validated
- Notes: M003 proves provisioning isolation (separate repos and workspaces per project). M004/S02 proves runtime isolation (22 multi-project tests: isolated state maps, event routing, failure isolation, fleet queries, 3 live concurrent tests).
...
- Supporting slices: M001/S05, M004/S02
- Validation: validated
- Notes: M004/S01 proved single-project agent visibility (spawning, status, output, floor location). M004/S02 proved multi-project concurrent visibility with isolated state, escalation indicators on dashboard and floor, retry-in-progress indicators, agent telemetry display (tokens, cost, progress), and timeout-distinct-from-failure visibility — across 205+ tests including live multi-project integration.
...
- Validation: validated
- Notes: M004/S02 proves one-retry-then-escalate lifecycle: auto-retry on first agent failure, escalation on second, operator acknowledgment with retry/abort controls. 26 service unit tests, 33 UI tests, 3 live integration tests. Timeout treated as retryable failure with distinct UI treatment.
...
| R004 | operability | validated | M002/S04 | M001/S03, M002/S01 | validated |
| R005 | core-capability | validated | M002/S01 | M002/S04 | validated |
| R006 | core-capability | validated | M002/S02 | M002/S04 | validated |
| R007 | core-capability | validated | M002/S02 | M002/S04 | validated |
| R008 | differentiator | validated | M002/S03 | M002/S04 | validated |
| R009 | integration | validated | M002/S03 | M005/S01 | validated |
...
| R013 | integration | validated | M003/S02 | M004/S01, M004/S02 | validated |
| R014 | quality-attribute | validated | M003/S01 | M004/S02 | validated |
| R015 | failure-visibility | validated | M004/S01 | M001/S05, M004/S02 | validated |
| R016 | operability | validated | M001/S03 | M001/S05, M001/S06, M004 (provisional) | validated |
| R017 | continuity | validated | M004/S02 | M004/S01 | validated |
| R018 | compliance/security | active | M005/S02 | M002 (provisional) | unmapped |
| R019 | integration | validated | M002/S01 | M002/S02, M002/S03, M002/S04 | validated |
...
| R025 | integration | active | M005/S02 | none | unmapped |
...
- Mapped to slices: 3
- Validated: 18 (R001, R002, R003, R004, R005, R006, R007, R008, R009, R010, R012, R013, R014, R015, R016, R017, R019, R020)
